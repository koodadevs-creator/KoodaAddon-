...
public class CrystalMetrics extends HudElement {
    public static final HudElementInfo<CrystalMetrics> INFO = new HudElementInfo<>(KoodaAddon.KOODA_HUD_GROUP, "crystal-metrics", "ThunderHack Style CPA Monitor.", CrystalMetrics::new);
    ...
    private final Setting<SettingColor> colorLine = sgVisuals.add(new ColorSetting.Builder().name("line-color").description("Main line color.").defaultValue(new SettingColor(KoodaAddon.KOODA_COLOR.r, KoodaAddon.KOODA_COLOR.g, KoodaAddon.KOODA_COLOR.b, 255)).build());
    private final Setting<SettingColor> colorFill = sgVisuals.add(new ColorSetting.Builder().name("fill-color").description("Under graph fill.").defaultValue(new SettingColor(KoodaAddon.KOODA_COLOR.r, KoodaAddon.KOODA_COLOR.g, KoodaAddon.KOODA_COLOR.b, 40)).build());
    private final Setting<SettingColor> colorBg = sgVisuals.add(new ColorSetting.Builder().name("background").description("Panel background.").defaultValue(new SettingColor(10, 10, 10, 180)).build());
